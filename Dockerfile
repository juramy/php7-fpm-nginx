...
RUN echo "deb https://packages.sury.org $(lsb_release -sc) main" | tee /etc/apt/sources.list.d/php.list
RUN echo "deb-src https://packages.sury.org $(lsb_release -sc) main" | tee -a /etc/apt/sources.list.d/php.list
