...
RUN echo "deb https://deb.sury.org $(lsb_release -sc) all" | tee /etc/apt/sources.list.d/php.list
RUN echo "deb-src https://deb.sury.org $(lsb_release -sc) all" | tee -a /etc/apt/sources.list.d/php.list
